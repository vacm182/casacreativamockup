...
3. En `propiedades.js`, dentro del bloque de esa propiedad, agrega una línea nueva `videos:` (puede ir después de `imgs:`), con una **lista** de rutas (aunque solo tengas un video, va entre corchetes `[ ]`):

```js
videos: ["/Images/Piso en venta en Calle Pintor Juan Frances, 11, Xátiva — idealista/video.mp4"],
```

Si tienes más de un video para la misma propiedad, agrégalos separados por coma dentro de la misma lista:
...
videos: ["/Images/Piso%20en%20venta%20en%20Calle%20Pintor...idealista/video.mp4"],
```
